...
RUN mkdir -p /usr/src/zalf_geonode
...
COPY src /usr/src/zalf_geonode/
WORKDIR /usr/src/zalf_geonode
...
RUN chmod +x /usr/src/zalf_geonode/tasks.py \
    && chmod +x /usr/src/zalf_geonode/entrypoint.sh
...
# ENTRYPOINT /usr/src/zalf_geonode/entrypoint.sh
